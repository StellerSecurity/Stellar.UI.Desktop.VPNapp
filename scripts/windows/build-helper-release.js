...
const builtHelper = path.join(tauriDir, 'target', 'release', 'stellar-vpn-helper-windows.exe');
...
const build = spawnSync('cargo', ['build', '--release', '--bin', 'stellar-vpn-helper-windows'], {
  cwd: tauriDir,
  stdio: 'inherit',
  windowsHide: false,
});
